...
다루는 시장: 미국 NASDAQ / S&P500, 가상화폐, 유럽 명품 섹터, 크립토-주식 상관관계.
...
1. **2017년부터 블록체인 시장에서 일하며 한국과 중국의 가교 역할을 해왔습니다.** 한쪽 시장에서 작동한 가설이 다른 쪽에서는 반대로 움직이는 경험을 반복했습니다. 이 격차를 읽는 것이 출발점입니다.

2. **AI는 도구입니다 — 엑셀처럼.** LLM은 만능이 아닙니다. 모델을 읽는 인간의 통찰력이 더 중요합니다.
...
5. **데이터를 공개합니다.** 14개 이상의 CSV로 누구나 검증할 수 있게 합니다. 닫힌 알파는 알파가 아닙니다.

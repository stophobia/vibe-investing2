...
새벽 5시 17분, 대시보드의 알람 패널이 쉬지 않고 깜빡입니다.

![실시간 괴리율 알람 — 프리미엄/디스카운트 되돌림 후보가 초 단위로 쌓인다](docs/alerts.png)
...
![KODEX200 차익거래 봇 대시보드 — 빅2 합성지수와 추종 ETF의 lead-lag gap·괴리율](docs/dashboard.png)
